...
class SOFA():
    ...
    def createScene(self):
        ...
        VisuCatheter.addObject('AdaptiveBeamMapping', name='VisuMapCath', useCurvAbs=True, printLog=True, interpolation='@../InterpolCatheter', input='@../DOFs', output='@Quads', isMechanical=False)
        VisuCatheterOgl = VisuCatheter.addChild('VisuOgl', activated=True)
        VisuCatheterOgl.addObject('OglModel', name='Visual', color=[0.7, 0.4, 1, 0.6], quads='@../ContainerCath.quads', material='texture Ambient 1 0.2 0.2 0.2 0.0 Diffuse 1 1.0 1.0 1.0 1.0 Specular 1 1.0 1.0 1.0 1.0 Emissive 0 0.15 0.05 0.05 0.0 Shininess 1 20')
        ...
        VisuGuide.addObject('AdaptiveBeamMapping', name='visuMapGuide', useCurvAbs=True, printLog=True, interpolation='@../InterpolGuide', input='@../DOFs', output='@Quads', isMechanical=False)
        VisuGuideOgl = VisuGuide.addChild('VisuOgl')
        VisuGuideOgl.addObject('OglModel', name='Visual', color=[0.7, 0.4, 1, 0.6], material='texture Ambient 1 0.2 0.2 0.2 0.0 Diffuse 1 1.0 1.0 1.0 1.0 Specular 1 1.0 1.0 1.0 1.0 Emissive 0 0.15 0.05 0.05 0.0 Shininess 1 20', quads='@../ContainerGuide.quads')
        ...
        VisuCoils.addObject('AdaptiveBeamMapping', name='visuMapCoils', useCurvAbs=True, printLog=True, interpolation='@../InterpolCoils', input='@../DOFs', output='@Quads', isMechanical=False)
        VisuCoilsOgl = VisuCoils.addChild('VisuOgl')
        VisuCoilsOgl.addObject('OglModel', name='Visual', color=[0.7, 0.4, 1, 0.6], material='texture Ambient 1 0.2 0.2 0.2 0.0 Diffuse 1 1.0 1.0 1.0 1.0 Specular 1 1.0 1.0 1.0 1.0 Emissive 0 0.15 0.05 0.05 0.0 Shininess 1 20', quads='@../ContainerCoils.quads')
    ...
    def simple_render(self):
        ...
        OpenGL.GL.glMatrixMode(OpenGL.GL.GL_PROJECTION)
        OpenGL.GL.glLoadIdentity()
        OpenGL.GLU.gluPerspective(30, (self.display_size[0] / self.display_size[1]), zNear, zFar)
        OpenGL.GL.glMatrixMode(OpenGL.GL.GL_MODELVIEW)
        OpenGL.GL.glLoadIdentity()
...
if __name__ == "__main__":
    ...
    sofa = SOFA(r'G:\v24.06.00\SofaGuidewireNav-main\SofaGW\vessel\phantom.obj')
    for i in range(10):
        sofa.action(1,0.5)
        sofa.step(False)
        image = sofa.GetImage()
